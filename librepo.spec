...
Version  : 1.10.6
Release  : 26
URL      : https://github.com/rpm-software-management/librepo/archive/1.10.6/librepo-1.10.6.tar.gz
Source0  : https://github.com/rpm-software-management/librepo/archive/1.10.6/librepo-1.10.6.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1568924465
mkdir -p clr-build
pushd clr-build
