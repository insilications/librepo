...
Version  : 1.10.5
Release  : 25
URL      : https://github.com/rpm-software-management/librepo/archive/1.10.5/librepo-1.10.5.tar.gz
Source0  : https://github.com/rpm-software-management/librepo/archive/1.10.5/librepo-1.10.5.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1567201843
mkdir -p clr-build
pushd clr-build
