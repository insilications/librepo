...
Version  : 1.9.4
Release  : 20
URL      : https://github.com/rpm-software-management/librepo/archive/1.9.4.tar.gz
Source0  : https://github.com/rpm-software-management/librepo/archive/1.9.4.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1550708062
mkdir -p clr-build
pushd clr-build
