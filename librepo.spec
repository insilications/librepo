...
Version  : 1.12.0
Release  : 33
URL      : https://github.com/rpm-software-management/librepo/archive/1.12.0/librepo-1.12.0.tar.gz
Source0  : https://github.com/rpm-software-management/librepo/archive/1.12.0/librepo-1.12.0.tar.gz
...
%prep
%setup -q -n librepo-1.12.0
cd %{_builddir}/librepo-1.12.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1591759061
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/librepo-1.12.0/COPYING %{buildroot}/usr/share/package-licenses/librepo/01a6b4bf79aca9b556822601186afab86e8c4fbf
pushd clr-build
%make_install
popd
