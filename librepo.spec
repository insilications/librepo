...
Version  : 1.9.1
Release  : 15
URL      : https://github.com/rpm-software-management/librepo/archive/1.9.1.tar.gz
Source0  : https://github.com/rpm-software-management/librepo/archive/1.9.1.tar.gz
Summary  : Repodata downloading library
Group    : Development/Tools
License  : LGPL-2.1 LGPL-2.1+
Requires: librepo-python3
Requires: librepo-lib
Requires: librepo-license
...
export LANG=C
export SOURCE_DATE_EPOCH=1535566102
mkdir -p clr-build
pushd clr-build
...
export SOURCE_DATE_EPOCH=1535566102
rm -rf %{buildroot}
mkdir -p %{buildroot}/usr/share/doc/librepo
cp COPYING %{buildroot}/usr/share/doc/librepo/COPYING
pushd clr-build
%make_install
popd
