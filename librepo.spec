...
Version  : 1.11.0
Release  : 28
URL      : https://github.com/rpm-software-management/librepo/archive/1.11.0/librepo-1.11.0.tar.gz
Source0  : https://github.com/rpm-software-management/librepo/archive/1.11.0/librepo-1.11.0.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1572219240
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/librepo-1.11.0/COPYING %{buildroot}/usr/share/package-licenses/librepo/01a6b4bf79aca9b556822601186afab86e8c4fbf
pushd clr-build
%make_install
popd
