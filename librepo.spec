...
Version  : 1.9.5
Release  : 21
URL      : https://github.com/rpm-software-management/librepo/archive/1.9.5.tar.gz
Source0  : https://github.com/rpm-software-management/librepo/archive/1.9.5.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1552944594
mkdir -p clr-build
pushd clr-build
